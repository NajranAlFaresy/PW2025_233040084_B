...
<form action="{{ route('dashboard.store') }}" method="POST" enctype="multipart/form-data>
    ...
    <div class="grid gap-4 grid-cols-2">
        ...
        <div class="col-span-2">
            ...
            <input
                ...
                id="title"
                value="{{ old('title') }}"
                class="bg-neutral-secondary/10 border border-default rounded-base text-heading text-sm focus:ring-brand focus:border-brand w-full px-3 py-2.5 shadow-xs placeholder:text-body"
        ...
        <div class="col-span-2">
            ...
            <textarea
                ...
                id="excerpt"
                rows="3"
                class="block bg-neutral-secondary/10 border border-default rounded-base text-heading text-sm focus:ring-brand focus:border-brand w-full px-3 py-2.5 shadow-xs placeholder:text-body"
    ...
    <div class="flex items-center space-x-4 border-t border-default pt-4 md:pt-6 mt-4 md:mt-6">
        ...
        <button type="submit"
            class="inline-flex items-center text-white bg-brand hover:bg-brand-strong rounded-base text-sm font-medium px-4 py-2 shadow-xs">
            Create
        </button>

        <a href="{{ route('dashboard.index') }}"
           class="text-sm text-body hover:text-heading transition bg-neutral-secondary/10 border border-default rounded-base px-4 py-2 shadow-xs">
            Cancel
        </a>
